...
import 'package:mspeed/common/libraries/src/MonthSelector.dart';
import 'package:mspeed/common/libraries/src/YearSelector.dart';
import 'package:mspeed/common/libraries/src/common.dart';
import 'package:mspeed/common/libraries/src/locale_utils.dart';
...
class _MonthPickerDialogState extends State<_MonthPickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      data:
          Theme.of(context).copyWith(dialogTheme: DialogThemeData(backgroundColor: Colors.transparent)),
      child: Dialog(
        child: Column(
                    ...
                    ? GestureDetector(
                        ...
                        child: new StreamBuilder<UpDownPageLimit>(
                          ...
                          builder: (_, snapshot) => Text(
                            '${DateFormat.y().format(DateTime(snapshot.data!.upLimit))}',
                    ...
                    : new StreamBuilder<UpDownPageLimit>(
                        ...
                        builder: (_, snapshot) => Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              '${DateFormat.y().format(DateTime(snapshot.data!.downLimit))}',
                              style: theme.primaryTextTheme.headlineMedium,
                            ),
                          ],
                        ),
