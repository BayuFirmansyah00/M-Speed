...
// import 'package:mspeed/src/product/view/product_list_view_not_login.dart';
...
//
// class ProductPromoViewNotLogin extends StatefulWidget {
//   final String keyword;
//   const ProductPromoViewNotLogin({super.key, required this.keyword});
//
...
//       ], child: ProductPromoViewNotLogin(keyword: keyword));
//
//   @override
//   State<ProductPromoViewNotLogin> createState() =>
//       _ProductPromoViewNotLoginState();
// }
//
// class _ProductPromoViewNotLoginState
//     extends BaseState<ProductPromoViewNotLogin> {
...
//                           return ProductDetailViewNotLogin(id: product.id ?? 0);
//                         }));
//                       });
//                     },
//                   );
...
//                   children: [
//                     // SizedBox(height: 20),
//                     // Text('Shop by Category', style: Constant.blueBold20),
//                     // SizedBox(height: 20),
//                     // categoryFilter(),
//                     SizedBox(height: 20),
//                     Row(
