...
class EMateraiUploadWidget extends StatefulWidget {
  const EMateraiUploadWidget({
    Key? key,
  ...
  @override
  State<EMateraiUploadWidget> createState() => _EMateraiUploadWidgetState();
}

class _EMateraiUploadWidgetState extends State<EMateraiUploadWidget> {
  int? resetDate;
