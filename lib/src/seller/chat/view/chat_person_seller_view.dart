...
class _ChatPersonViewState extends State<ChatPersonView> {
  ...
  @override
  void initState() {
    context.read<ChatSellerProvider>().detailChatSellerModel =
  ...
  Future<void> initData() async {
    ...
    context.read<ChatSellerProvider>().fetchDetailChat(context,
        withLoading: true, idBuyer: widget.id, idSeller: userId);
  }
  ...
  Widget build(BuildContext context) {
    final chatModel = context.watch<ChatSellerProvider>().detailChatSellerModel;
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          context.read<ChatSellerProvider>().fetchDetailChat(context,
              idSeller: userId, idBuyer: widget.id, withLoading: true);
        },
        child: Column(
          children: [
            Expanded(
          ...
          CircleAvatar(
            ...
            child: IconButton(
              ...
              onPressed: () {
                ...
                context.read<ChatSellerProvider>().sendChat(context,
                    withLoading: true,
