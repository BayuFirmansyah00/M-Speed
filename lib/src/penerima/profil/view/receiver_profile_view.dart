...
// ── Theme Colors ───────────────────────────────────────────────────────────
const Color _kPrimary = Color(0xFF0284C7); // Sky Blue / Logistics Theme
...
class ReceiverProfileView extends StatefulWidget {
  const ReceiverProfileView({super.key});

  @override
  State<ReceiverProfileView> createState() => _ReceiverProfileViewState();
}

class _ReceiverProfileViewState extends BaseState<ReceiverProfileView> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<PenerimaPesananProvider>().loadProfile();
    });
  }
  ...
  Future<void> _handleLogout() async {
    await Utils.showYesNoDialog(
      ...
      desc: 'Apakah Anda yakin ingin keluar dari akun Penerima?',
      yesCallback: () async {
        CusNav.nPop(context);
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Anda saat ini sedang login sebagai Divisi Penerima (Receiver) melalui akun Administrator.',
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        p.receiverEmail.isNotEmpty ? p.receiverEmail : '-',
            ...
            child: Column(
              children: [
                _MenuItem(
                  ...
                  title: 'Informasi Akun Penerima',
                  subtitle: p.receiverEmail.isNotEmpty ? p.receiverEmail : 'Data profil akun Receiver',
                  onTap: () {
                    Utils.showSuccess(msg: 'Nama: ${p.receiverName}\nRole: ${p.receiverRole}');
                  },
                ),
                const Divider(height: 1, color: _kBorder),
                _MenuItem(
                  icon: Icons.fact_check_outlined,
                  title: 'Otoritas & Tugas',
                  subtitle: 'Verifikasi & Konfirmasi Penerimaan Fisik Barang',
                  onTap: () {},
                ),
                const Divider(height: 1, color: _kBorder),
                _MenuItem(
