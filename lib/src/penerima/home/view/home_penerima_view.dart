...
// ── Theme Colors ───────────────────────────────────────────────────────────
const Color _kPrimary = Color(0xFF0284C7);      // Sky Blue
const Color _kPrimaryDark = Color(0xFF0369A1);  // Dark Blue
const Color _kPrimaryLight = Color(0xFFE0F2FE); // Soft Blue
const Color _kSuccess = Color(0xFF10B981);      // Emerald Green
const Color _kSuccessLight = Color(0xFFD1FAE5);
const Color _kWarning = Color(0xFFF59E0B);      // Amber
...
class HomePenerimaView extends StatefulWidget {
  final VoidCallback? onNavigateToOrders;
  const HomePenerimaView({super.key, this.onNavigateToOrders});

  @override
  State<HomePenerimaView> createState() => _HomePenerimaViewState();
}

class _HomePenerimaViewState extends BaseState<HomePenerimaView> {
  ...
  Widget build(BuildContext context) {
    ...
    final urgentOrders = orders.where((o) => o.canVerifyReception).toList();
        ...
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                const Text(
                                  'Total Nilai Pengiriman Diterima',
                                  style: TextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.w600,
                                    color: Colors.white,
                            ...
                            const SizedBox(height: 12),
                            Text(
                              _currencyFormat.format(p.kpiTotalNominal),
                              style: const TextStyle(
                                fontSize: 24,
                                fontWeight: FontWeight.w800,
                                color: Colors.white,
                            ...
                            Text(
                              'Dari ${p.kpiTotalPesanan} alokasi pesanan',
                              style: TextStyle(
                                fontSize: 12,
                        ...
                        children: [
                          Expanded(
                            child: _KpiStatCard(
                              ...
                              count: p.kpiSiapDiterima,
                              color: _kWarning,
                              bgColor: _kWarningLight,
                              icon: Icons.pending_actions_rounded,
                              isActionNeeded: p.kpiSiapDiterima > 0,
              ...
              // ── Action-Required Banner (Perlu Verifikasi) ────────────────
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        const Text(
                          'Perlu Verifikasi Penerimaan Barang',
                          style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.w800,
                            color: _kTextPrimary,
                      ...
                      return Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            CusNav.nPush(
                              context,
                              PenerimaPesananDetailView(transactionId: order.id.toString()),
                            );
                          },
                    ...
                    child: Center(
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 12),
                          const Text(
                            'Belum ada data pesanan penerimaan',
                            style: TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.w600,
                              color: _kTextSecondary,
