...
class OrderItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final canVerify = order?.canVerifyReception ?? false;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: (highlightAction || canVerify)
              ? const Color(0xFFF59E0B).withValues(alpha: 0.5)
              : const Color(0xFFEBEBF0),
          width: (highlightAction || canVerify) ? 1.5 : 1,
        ),
      ),
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.receipt_long_rounded, color: Color(0xFF0284C7), size: 18),
          ...
          // Body Card (Seller, Buyer & Status Details)
          Padding(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.storefront_rounded, color: Color(0xFF0284C7), size: 16),
                    ),
