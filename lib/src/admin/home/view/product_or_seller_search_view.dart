    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return DraggableScrollableSheet(
          // minChildSize: 0.25, // Adjust this value to the minimum height you want
          // maxChildSize: 0.8, // Adjust this value to the maximum height you want
