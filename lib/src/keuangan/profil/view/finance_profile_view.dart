...
// ── Brand Colors ───────────────────────────────────────────────────────────
const Color _kPrimary = Color(0xFFD97706); // Amber/Gold Finance Theme
...
class FinanceProfileView extends StatefulWidget {
  const FinanceProfileView({super.key});

  @override
  State<FinanceProfileView> createState() => _FinanceProfileViewState();
}

class _FinanceProfileViewState extends BaseState<FinanceProfileView> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<KeuanganProvider>().loadProfile();
    });
  }
  ...
  Future<void> _handleLogout() async {
    await Utils.showYesNoDialog(
      ...
      desc: 'Apakah Anda yakin ingin keluar dari akun Finance?',
      yesCallback: () async {
        CusNav.nPop(context);
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Anda saat ini sedang login sebagai Divisi Finance melalui akun Administrator.',
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        p.financeEmail.isNotEmpty ? p.financeEmail : '-',
            ...
            child: Column(
              children: [
                _MenuItem(
                  ...
                  title: 'Informasi Akun Finance',
                  subtitle: p.financeEmail.isNotEmpty ? p.financeEmail : 'Data profil akun Finance',
                  onTap: () {
                    Utils.showSuccess(msg: 'Nama: ${p.financeName}\nRole: ${p.financeRole}');
                  },
                ),
                ...
                _MenuItem(
                  ...
                  subtitle: 'Proses & Pembayaran Tagihan Pesanan Buyer',
                  onTap: () {},
                ),
                const Divider(height: 1, color: _kBorder),
                _MenuItem(
