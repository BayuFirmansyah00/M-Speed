...
///
class DaftarTransaksiKeuanganModelData {
/*
{
  "ID": "91",
...
*/
  ...
  DaftarTransaksiKeuanganModelData({
    this.ID,
    this.Created,
    this.Updated,
    this.nomorOrder,
  ...
  DaftarTransaksiKeuanganModelData.fromJson(Map<String, dynamic> json) {
...
class DaftarTransaksiKeuanganModel {
/*
{
  "result": "success",
  "data": [
...
*/
  ...
  String? result;
  List<DaftarTransaksiKeuanganModelData?>? data;

  DaftarTransaksiKeuanganModel({
    this.result,
    this.data,
  });
  DaftarTransaksiKeuanganModel.fromJson(Map<String, dynamic> json) {
    result = json['result']?.toString();
    if (json['data'] != null) {
      final v = json['data'];
      final arr0 = <DaftarTransaksiKeuanganModelData>[];
      v.forEach((v) {
        arr0.add(DaftarTransaksiKeuanganModelData.fromJson(v));
      });
      this.data = arr0;
    }
  }
