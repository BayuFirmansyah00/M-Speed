...
class Utils {
  ...
  static InkWell RoundedButton({
    ...
    return InkWell(
      ...
      child: Material.Card(
        child: Padding(
          child:
              child ?? Icon(Icons.chevron_left, color: Constant.primaryColor),
          ...
          Row(
            ...
            children: [
              ...
              if (forDetail && suffixIcon != null)
                Material.SizedBox(width: 120, child: suffixIcon),
            ],
          ),
        ],
      ),
  ...
  static convertDateddMMMMyyyyHHmm(String date) {
    return DateFormat("dd MMMM yyyy HH:mm").format(DateTime.parse(date));
  }

  static convertDateddMMMMyyyyCommaHHmm(String date) {
    return DateFormat("dd MMMM yyyy, HH:mm").format(DateTime.parse(date));
  }
  ...
  static mainButton(
    ...
    return ElevatedButton(
      ...
      child: Container(
        ...
        child: Text(
          str,
          style: TextStyle(fontSize: textSize ?? Constant.fontSizeRegular),
  ...
  static String thousandSeparator(int val, {String symbol = "Rp "}) {
  ...
  static String thousandSeparatorFromString(
    String val, {
    String symbol = "Rp ",
  }) {
    val = val.replaceAll(new RegExp(r'[^0-9]'), '');
